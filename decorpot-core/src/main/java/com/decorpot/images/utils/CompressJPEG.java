...
public class CompressJPEG {
	public static void main(String[] args) throws FileNotFoundException,IOException {
		...
		File file =  new File("../../../imgs_decor/Off-Sarjapur-Road_hd/sorted");
		...
		for (String str : fileNameList) 
		{
			if(str != null)
			{
				File imageFile = new File("../../../imgs_decor/Off-Sarjapur-Road_hd/sorted/"+str);
				
				//Check jpg file
				boolean tmp = imageFile.getName().contains(".jpg");
				System.out.println("is Jpg file = "+tmp);
				
				File compressedFile = new File("../../../imgs_decor/Off-Sarjapur-Road_med/sorted/"+str);
				if(tmp)
				{
