...
<link rel="shortcut icon" href="resources/core/img/decorFinalIcon.png"
	type="image/x-icon">
	...
	<div id="header" ng-controller="DecorpotCtrl">
		...
		<div class="row" style="margin-top: 1%;">
			<div id="logo" class="col-md-3">
				<a href="#/"><img src="resources/core/img/FINALCOLORLOGO1.png"
					width="300" height="43" alt="" /></a>
			</div>
			<div class=" navigation-bar col-md-9">
				<div class="col-md-2 right text-muted">
				<i class="fa fa-envelope-o">careers@decorpot.com</i>
					
				</div>
				<div class="col-md-2 right right text-muted">
					<span><i class="fa fa-phone"></i></span>
					<span><div class = "col-md-12 left"> +91 9986076762</div>
					<div class = "col-md-12 left">+91 9986076761</div>
					</span>
				</div>
			</div>
		</div>
		<div class="inner relative">
			...
			<nav id="navigation">
				<ul id="main-menu">
					...
					<li class="parent">
						<a ui-sref="imageList({param : 'looks'})">Looks</a>
						<ul class="sub-menu">
					...
					<li ><a ui-sref="projects">Completed Projects</a>
						</li>
					<li ><a ui-sref="contacts">Contact
								us</a></li>
					<li><a ui-sref="about">About
								us</a></li>
